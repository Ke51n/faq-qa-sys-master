...
import com.example.faq.mapper.TaxTextMapper;
...
public class ManagementServiceImpl implements ManagementService {
    ...
    @Autowired
    private TaxTextMapper taxTextMapper;
    @Autowired
    ...
    public int totalSynchronize(String tableIndexName) throws IOException {
        ...
        //查询中央政策文本
//        List<TaxText> taxTextList = taxTextMapper.selectAll();
//        System.out.println("=====================================================");
//        System.out.println(faqPairList);
        //es client初始化
        ...
        //插入数据 todo 修改用以插入政策文档数据
        IndexRequest request = null;
        int size = faqPairList.size();
//        int size = taxTextList.size();
        for (FaqPair taxText : faqPairList) {
//        for (TaxText taxText : taxTextList) {
            Map<String, Object> jsonMap = new HashMap<>();
            jsonMap.put("idx", taxText.getId());
//            jsonMap.put("url", taxText.getUrl());
            jsonMap.put("question", taxText.getStandardQuestion());
//            jsonMap.put("abstract", taxText.getAbstract1());
            jsonMap.put("answer", taxText.getStandardAnswer());
